...
#i used the second hint, exercise 1.19 to understand how to do it, explanation: https://kendyck.com/2005/05/13/solution-to-sicp-exercise-119/
...
def fib(n):
    if n < 0:
        n *= -1
        return fibIter(1, 0, 0, 1, n)*((-1)**((n%2)+1)) #Fibonnaci for negative numbers F-n = (-1)^(n+1) * Fn
    else:
